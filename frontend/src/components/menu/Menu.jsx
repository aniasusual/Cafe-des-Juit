...
const Menu = () => {
    ...
    const loadData = async()=>{
        ...
        let response = await fetch("https://cafejuit.onrender.com/api/foodData",{
            method:"POST",
            headers:{
        ...
        <div>
            ...
            <div id="carouselExampleCaptions" className="carousel slide" >
                ...
                <div className="d-flex justify-content-center mt-5" role="search">
                    <input  className="form-control me-2 bg-transparent w-50 text-warning"  type="search" placeholder="Search" aria-label="Search" value={search} onChange={(e)=>{setSearch(e.target.value)}}/>
